...
Now automatic conversion to output format requires 3 steps: getting preliminary content file, creating fodt file, converting fodt to odt, pdf, docx. There should be definitely a command that does the whole routine in one step.
